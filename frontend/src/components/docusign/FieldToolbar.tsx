	...
	return (
		<div className="bg-slate-900 border border-slate-700 rounded-lg p-4 shadow-sm">
			<div className="flex items-center justify-between mb-3">
				<h3 className="text-sm font-semibold text-white">Add Field</h3>
				<div className="text-xs text-gray-400">Click on document to place</div>
			</div>
				...
				{fieldTypes.map((fieldType) => {
					...
					return (
							...
							className={`
								...
								${
									isSelected
										...
										: "bg-slate-800 hover:bg-slate-700 text-gray-300 border-slate-600 hover:border-slate-500"
								}
						...
						>
							...
							{isSelected && (
								<div className="absolute -top-1 -right-1 w-4 h-4 bg-white text-slate-800 rounded-full flex items-center justify-center">
