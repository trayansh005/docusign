...
export const SignaturePad: React.FC<SignaturePadProps> = ({
    ...
    const signatureFonts = [
        ...
        { name: "script", label: "Script", style: "font-family: 'Brush Script MT', cursive;" },
        { name: "elegant", label: "Elegant", style: "font-family: 'Great Vibes', cursive;" },
        { name: "modern", label: "Modern", style: "font-family: 'Kalam', cursive;" },
    ];

    useEffect(() => {
        // Load signature fonts
        const link = document.createElement("link");
        link.href = "https://fonts.googleapis.com/css2?family=Dancing+Script:wght@400;600&family=Great+Vibes&family=Kalam:wght@400;700&display=swap";
        link.rel = "stylesheet";
        ...
        <div className={`bg-white rounded-lg shadow-lg p-6 ${className}`}>
            ...
            <div className="flex gap-2 mb-4">
                <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${signatureMode === "draw"
                ...
                <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${signatureMode === "type"
                        ? "bg-blue-100 text-blue-700 border border-blue-300"
                        : "bg-gray-100 text-gray-600 hover:bg-gray-200"
                        }`}
                >
                ...
                <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            {signatureFonts.map((font) => (
                                <button
                                    ...
                                    className={`p-3 text-left border rounded-lg transition-colors ${selectedFont === font.name
                                        ? "border-blue-500 bg-blue-50"
                                        : "border-gray-300 hover:border-gray-400"
                                        }`}
                                >
                                    <div
                                        style={{ fontFamily: font.style.split(":")[1].replace(/'/g, "") }}
                                        className="text-lg"
                                    >
                    ...
                    {typedSignature && (
                        <div className="p-4 bg-gray-50 rounded-lg border">
                            ...
                            <div
                                style={{
                                    fontFamily: signatureFonts.find(f => f.name === selectedFont)?.style.split(":")[1].replace(/'/g, ""),
                                    fontSize: "24px",
                                    textAlign: "center",
                                }}
                            >
