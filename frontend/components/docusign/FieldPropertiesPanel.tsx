...
export const FieldPropertiesPanel: React.FC<FieldPropertiesPanelProps> = ({
	...
	return (
		<div className="bg-slate-900 border border-slate-700 rounded-lg shadow-lg p-4 w-80">
			<div className="flex items-center justify-between mb-4">
				<div className="flex items-center gap-2">
					<Settings className="w-4 h-4 text-gray-300" />
					<h3 className="text-sm font-semibold text-white">Field Properties</h3>
				</div>
			...
			<div className="space-y-4">
				{/* Field Type */}
				<div>
					<label className="block text-xs font-medium text-gray-200 mb-1">Field Type</label>
					<select
						value={localField.type}
						onChange={(e) => handleInputChange("type", e.target.value)}
						className="w-full px-3 py-2 text-sm border border-slate-600 rounded-md bg-slate-800 text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
					>
				...
				{/* Recipient ID */}
				<div>
					<label className="block text-xs font-medium text-gray-200 mb-1">Recipient ID</label>
					<input
						type="text"
				...
				<div className="grid grid-cols-2 gap-3">
					<div>
						<label className="block text-xs font-medium text-gray-200 mb-1">X Position (%)</label>
						<input
							type="number"
							min="0"
							max="100"
					...
					<div>
						<label className="block text-xs font-medium text-gray-200 mb-1">Y Position (%)</label>
						<input
							type="number"
							min="0"
							max="100"
				...
				<div className="grid grid-cols-2 gap-3">
					<div>
						<label className="block text-xs font-medium text-gray-200 mb-1">Width (%)</label>
						<input
							type="number"
							min="1"
							max="100"
					...
					<div>
						<label className="block text-xs font-medium text-gray-200 mb-1">Height (%)</label>
						<input
							type="number"
							min="1"
							max="100"
				...
				<div className="flex items-center gap-2">
					...
					/>
					<label htmlFor="required" className="text-xs font-medium text-gray-200">
						Required field
					</label>
				</div>
			</div>
